...
// Evitar que llaves de servicio o mal configuradas se usen en el navegador
if (!supabaseAnonKey || supabaseAnonKey.length < 50 || supabaseAnonKey.includes('service_role')) {
